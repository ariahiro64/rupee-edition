...
ChrisSpriteGFX::               INCBIN "gfx/player/link_sprite.2bpp"
ChrisBikeSpriteGFX::           INCBIN "gfx/player/link_bike.2bpp"
...
SurfingPikachuSpriteGFX::      INCBIN "gfx/player/aria_swim.2bpp"
...
SurfSpriteGFX::                INCBIN "gfx/player/link_swim.2bpp"
...
ARIASpriteGFX::                INCBIN "gfx/player/aria_sprite.2bpp"
ARIABikeSpriteGFX::            INCBIN "gfx/player/aria_bike.2bpp"
