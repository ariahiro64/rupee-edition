...
; Johto story events
	...
	const_skip ; unused
	const_skip ; unused
	const EVENT_HEALED_LON_LON
	const EVENT_GOT_TM13_FARORES_WIND_FROM_LON_LON_FARM
	const EVENT_TALKED_TO_FARMER_ABOUT_LON_LON
...
; Johto hidden items
	...
	const EVENT_TIN_TOWER_5F_HIDDEN_BLUE_POTION
	...
	const EVENT_TEAM_ROCKET_BASE_B1F_HIDDEN_FAIRY
	...
	const EVENT_GOLDENROD_UNDERGROUND_SWITCH_ROOM_ENTRANCES_HIDDEN_FAIRY
	const EVENT_MOUNT_MORTAR_1F_OUTSIDE_HIDDEN_HYPER_POTION
	const EVENT_MOUNT_MORTAR_1F_INSIDE_HIDDEN_MAX_REPEL
	const EVENT_MOUNT_MORTAR_2F_INSIDE_HIDDEN_BLUE_POTION
	const EVENT_MOUNT_MORTAR_B1F_HIDDEN_GREAT_FAIRY
	...
	const EVENT_WHIRL_ISLAND_B1F_HIDDEN_BLUE_POTION
	...
	const EVENT_DRAGONS_DEN_B1F_HIDDEN_FAIRY
...
; Kanto hidden items
	const EVENT_DIGLETTS_CAVE_HIDDEN_GREAT_FAIRY
	const EVENT_UNDERGROUND_PATH_HIDDEN_BLUE_POTION
	...
	const EVENT_ROUTE_2_HIDDEN_BLUE_POTION
	const EVENT_ROUTE_2_HIDDEN_FAIRY
	...
	const EVENT_ROUTE_11_HIDDEN_FAIRY
...
; Johto itemballs
	...
	const EVENT_MOUNT_MORTAR_1F_OUTSIDE_FAIRY
	const EVENT_MOUNT_MORTAR_1F_INSIDE_MOGMA_MITTS
	const EVENT_MOUNT_MORTAR_1F_INSIDE_GREAT_FAIRY
	...
	const EVENT_MOUNT_MORTAR_2F_INSIDE_TM_GILDED_SLASH
	const EVENT_MOUNT_MORTAR_2F_INSIDE_DRAGON_SCALE
	const EVENT_MOUNT_MORTAR_2F_INSIDE_ELIXER
	const EVENT_MOUNT_MORTAR_2F_INSIDE_MOGMA_MITTS
	...
	const EVENT_WHIRL_ISLAND_B1F_BLUE_POTION
	const EVENT_WHIRL_ISLAND_B1F_CARBOS
	const EVENT_WHIRL_ISLAND_B1F_CALCIUM
	const EVENT_WHIRL_ISLAND_B1F_NUGGET
	const EVENT_WHIRL_ISLAND_B1F_MOGMA_MITTS
	const EVENT_WHIRL_ISLAND_B2F_BLUE_POTION
	const EVENT_WHIRL_ISLAND_B2F_GREAT_FAIRY
	const EVENT_WHIRL_ISLAND_B2F_MAX_ELIXER
	const EVENT_SILVER_CAVE_ROOM_1_MAX_ELIXER
	const EVENT_SILVER_CAVE_ROOM_1_PROTEIN
	const EVENT_SILVER_CAVE_ROOM_1_MOGMA_MITTS
	const EVENT_SILVER_CAVE_ITEM_ROOMS_GREAT_FAIRY
	const EVENT_SILVER_CAVE_ITEM_ROOMS_BLUE_POTION
	...
	const EVENT_DARK_CAVE_BLACKTHORN_ENTRANCE_FAIRY
	const EVENT_DARK_CAVE_BLACKTHORN_ENTRANCE_TM_FARORES_WIND
	const EVENT_VICTORY_ROAD_TM_EARTHQUAKE
	const EVENT_VICTORY_ROAD_GREAT_FAIRY
	const EVENT_VICTORY_ROAD_BLUE_POTION
	...
	const EVENT_ROUTE_44_GREAT_FAIRY
	const EVENT_ROUTE_44_ULTRA_BALL
	const EVENT_ROUTE_45_NUGGET
	const EVENT_ROUTE_45_FAIRY
...
; Kanto itemballs
	...
	const EVENT_ROCK_TUNNEL_B1F_FAIRY
...
; New to Crystal
	...
	const EVENT_MOUNT_MORTAR_B1F_BLUE_POTION
