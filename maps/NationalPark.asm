...
TrainerLassARIAe:
	trainer LASS, ARIAE, EVENT_BEAT_LASS_ARIAE, LassARIAeSeenText, LassARIAeBeatenText, 0, .Script

.Script:
	endifjustbattled
	opentext
	writetext LassARIAeAfterBattleText
	waitbutton
	closetext
	end
...
NationalPark_MapEvents:
	...
	object_event  8, 14, SPRITE_LASS, SPRITEMOVEDATA_SPINRANDOM_FAST, 0, 0, -1, -1, PAL_NPC_BLUE, OBJECTTYPE_TRAINER, 3, TrainerLassARIAe, -1
