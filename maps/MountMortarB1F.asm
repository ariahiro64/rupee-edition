...
MountMortarB1FHiddenMaxRevive:
	hiddenitem GREAT_FAIRY, EVENT_MOUNT_MORTAR_B1F_HIDDEN_GREAT_FAIRY
...
MountMortarB1F_MapEvents:
	...
	object_event 34, 24, SPRITE_POKE_BALL, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, OBJECTTYPE_ITEMBALL, 0, MountMortarB1FBluePotion, EVENT_MOUNT_MORTAR_B1F_BLUE_POTION
