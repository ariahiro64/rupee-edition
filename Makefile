...
gfx/player/link.2bpp: rgbgfx += -h
gfx/player/link_back.2bpp: rgbgfx += -h
gfx/player/aria.2bpp: rgbgfx += -h
gfx/player/aria_back.2bpp: rgbgfx += -h

gfx/trainer_card/leaders.2bpp: tools/gfx += --trim-whitespace

gfx/overworld/link_fish.2bpp: tools/gfx += --trim-whitespace
gfx/overworld/ARIA_fish.2bpp: tools/gfx += --trim-whitespace
