...
FalknerGroup:
	...
	db  9, MURKROW,    AERIAL_ACE, PURSUIT, TOXIC, NO_MOVE
...
MortyGroup:
	...
	db 21, GASTLY,     SHADOW_FORCE, SPITE, MEAN_LOOK, CURSE
...
PryceGroup:
	...
	db 36, DEWGONG,    CURSE, ICY_WIND, SURF, AERIAL_ACE
...
Rival1Group:
	...
	db 20, HAUNTER,    SHADOW_FORCE, SPITE, MEAN_LOOK, CURSE
	...
	db 30, HAUNTER,    SHADOW_FORCE, MEAN_LOOK, CURSE, SHADOW_BALL
	...
	db 30, GOLBAT,     LEECH_LIFE, BITE, CONFUSE_RAY, WING_ATTACK
	db 28, MAGNEMITE,  TACKLE, THUNDERSHOCK, SONICBOOM, THUNDER_WAVE
	db 30, GENGAR,     SHADOW_FORCE, MEAN_LOOK, CURSE, SHADOW_BALL
	db 32, SNEASEL,    LEER, QUICK_ATTACK, SCREECH, FAINT_ATTACK
...
SchoolboyGroup:
	...
	db 35, XATU,       AERIAL_ACE, NIGHT_SHADE, SWIFT, FUTURE_SIGHT
...
LassGroup:
	...
	db 18, SNUBBULL,   SCARY_FACE, CHARM, BITE, SHADOW_FORCE
	db -1 ; end
...
CooltrainerMGroup:
	...
	db 35, KINGLER,    WATER_PULSE, STOMP, GUILLOTINE, PROTECT
	...
	db 32, KINGLER,    WATER_PULSE, STOMP, GUILLOTINE, PROTECT
...
CooltrainerFGroup:
	...
	db 33, HORSEA,     SMOKESCREEN, LEER, WHIRLPOOL, DRAGON_SMASH
	db 33, HORSEA,     SMOKESCREEN, LEER, WHIRLPOOL, DRAGON_SMASH
	db 35, SEADRA,     SWIFT, LEER, WATERFALL, DRAGON_SMASH
	db -1 ; end
...
PokemaniacGroup:
	...
	db 12, LICKITUNG,  SHADOW_FORCE, SUPERSONIC, CUT, NO_MOVE
	db -1 ; end
...
SwimmerFGroup:
	...
	db 22, GOLDEEN,    AERIAL_ACE, TAIL_WHIP, SUPERSONIC, HORN_ATTACK
	db -1 ; end
...
SailorGroup:
	...
	db 20, KRABBY,     WATER_PULSE, LEER, VICEGRIP, HARDEN
	db -1 ; end
...
SuperNerdGroup:
	...
	db 39, SEADRA,     SMOKESCREEN, DRAGON_SMASH, SURF, WATERFALL
	db -1 ; end
...
TwinsGroup:
	...
	db 35, DRATINI,    THUNDER_WAVE, DRAGON_SMASH, FLAMETHROWER, HEADBUTT
	db 35, DRATINI,    THUNDER_WAVE, DRAGON_SMASH, ICE_BEAM, HEADBUTT
	db -1 ; end

	; TWINS (10)
	db "LEA & PIA@", TRAINERTYPE_MOVES
	db 38, DRATINI,    THUNDER_WAVE, DRAGON_SMASH, ICE_BEAM, HEADBUTT
	db 38, DRATINI,    THUNDER_WAVE, DRAGON_SMASH, FLAMETHROWER, HEADBUTT
	db -1 ; end
...
MysticalmanGroup:
	...
	db 23, HAUNTER,    SHADOW_FORCE, HYPNOSIS, MEAN_LOOK, CURSE
