...
FalknerGroup:
	...
	db  10, HOOTHOOT,  HYPNOSIS, MUD_SLAP, REST, RETURN
	db  9, MURKROW,    FARORES_WIND, PURSUIT, TOXIC, NO_MOVE
	db  8, GLIGAR,     SCREECH, MUD_SLAP, WING_ATTACK, NO_MOVE
	db -1 ; end
...
WhitneyGroup:
	...
	db 19, JIGGLYPUFF, TRI_ATTACK, SING, FAINT_ATTACK, SWEET_KISS
	db 18, SENTRET,    FURY_SWIPES, QUICK_ATTACK, CURSE, HIDDEN_POWER
	db 20, PORYGON,    DOUBLE_EDGE, CONVERSION2, RECOVER, CURSE
	db -1 ; end

BugsyGroup:
	; BUGSY (1)
	db "BUGSY@", TRAINERTYPE_MOVES
	db 14, BUTTERFREE, SLEEP_POWDER, STUN_SPORE, PSYCHIC_M, NO_MOVE
	db 14, BEEDRILL,   SLUDGE_BOMB, AGILITY, SWORDS_DANCE, TWINEEDLE
	db 16, SCYTHER,    SWORDS_DANCE, WING_ATTACK, FURY_CUTTER, BATON_PASS
	db 15, PINECO,     SILVER_WIND, GIGA_DRAIN, CURSE, HIDDEN_POWER
	db 15, SPINARAK,   GROWTH, PURSUIT, SLUDGE_BOMB, HIDDEN_POWER
	db -1 ; end

MortyGroup:
	; MORTY (1)
	db "MORTY@", TRAINERTYPE_MOVES
	db 21, GASTLY,     SHADOW_FLARE, SPITE, MEAN_LOOK, CURSE
	db 21, HAUNTER,    HYPNOSIS, MIMIC, CURSE, NIGHT_SHADE
	db 25, GENGAR,     HYPNOSIS, SHADOW_BALL, SUBMISSION, CURSE
	db 25, MISDREAVUS, HYPNOSIS, SHADOW_BALL, HIDDEN_POWER, MEAN_LOOK
	db -1 ; end

PryceGroup:
	; PRYCE (1)
	db "PRYCE@", TRAINERTYPE_MOVES
	db 35, SNEASEL,    HIDDEN_POWER, IRON_TAIL, FURY_CUTTER, FAINT_ATTACK
	db 36, DEWGONG,    CURSE, ICY_WIND, SURF, FARORES_WIND
	db 37, PILOSWINE,  ICY_WIND, EARTHQUAKE, ROCK_SLIDE, CURSE
	db 36, JYNX,       ICY_WIND, LOVELY_KISS, PSYCHIC_M, SHADOW_BALL
	db -1 ; end

JasmineGroup:
	; JASMINE (1)
	db "JASMINE@", TRAINERTYPE_MOVES
	db 30, MAGNETON,   RAIN_DANCE, THUNDER, HIDDEN_POWER, AGILITY
	db 33, SKARMORY,   CURSE, STEEL_WING, DRILL_PECK, MUD_SLAP
	db 35, STEELIX,    SANDSTORM, IRON_TAIL, EARTHQUAKE, SHARPEN
	db -1 ; end
...
ChuckGroup:
	...
	db 28, HITMONTOP,  HYPNOSIS, MIND_READER, HI_JUMP_KICK, PURSUIT
	db 30, HERACROSS,  CURSE, MACH_PUNCH, FURY_CUTTER, THIEF
	db -1 ; end

ClairGroup:
	; CLAIR (1)
	db "CLAIR@", TRAINERTYPE_MOVES
	db 37, AERODACTYL, ANCIENTPOWER, DRAGONBREATH, WING_ATTACK, EARTHQUAKE
	db 38, DRAGONAIR,  DRAGONBREATH, HYDRO_PUMP, THUNDER, GROWTH
	db 39, GYARADOS,   DRAGONBREATH, WATERFALL, EARTHQUAKE, BLIZZARD
	db 40, KINGDRA,    DRAGONBREATH, SURF, ICE_BEAM, HAZE
	db -1 ; end
...
Rival1Group:
	...
	db 18, MAGNEMITE,  TACKLE, THUNDERSHOCK, SUPERSONIC, SONICBOOM
	db 20, ZUBAT,      LEECH_LIFE, SUPERSONIC, BITE, CONFUSE_RAY
	db 22, CLEFAIRY,   MINIMIZE, SWIFT, METRONOME, AMNESIA
	db -1 ; end
	...
	db 18, MAGNEMITE,  TACKLE, THUNDERSHOCK, SUPERSONIC, SONICBOOM
	db 20, ZUBAT,      LEECH_LIFE, SUPERSONIC, BITE, CONFUSE_RAY
	db 22, ESPEON,     GROWTH, CONFUSION, BITE, BATON_PASS
	db -1 ; end
	...
	db 30, HAUNTER,    SHADOW_FLARE, MEAN_LOOK, CURSE, SHADOW_BALL
	db 32, SNEASEL,    LEER, QUICK_ATTACK, SCREECH, FAINT_ATTACK
	db 32, RAICHU,     LOVELY_KISS, THUNDERBOLT, SURF, AGILITY
	db -1 ; end
	...
	db 30, HAUNTER,    SHADOW_FLARE, MEAN_LOOK, CURSE, SHADOW_BALL
	db 32, SNEASEL,    LEER, QUICK_ATTACK, SCREECH, FAINT_ATTACK
	db 32, CLEFABLE,   SWIFT, METRONOME, PSYCHIC_M, AMNESIA
	db -1 ; end
	...
	db 30, GOLBAT,     LEECH_LIFE, BITE, CONFUSE_RAY, WING_ATTACK
	db 28, MAGNEMITE,  TACKLE, THUNDERSHOCK, SONICBOOM, THUNDER_WAVE
	db 30, GENGAR,     SHADOW_FLARE, MEAN_LOOK, CURSE, SHADOW_BALL
	db 32, SNEASEL,    LEER, QUICK_ATTACK, SCREECH, FAINT_ATTACK
	db 32, ESPEON,     GROWTH, PSYCHIC_M, BITE, BATON_PASS
	db -1 ; end
	...
	db 38, RAICHU,     LOVELY_KISS, THUNDERBOLT, SURF, AGILITY
	db -1 ; end
	...
	db 35, GENGAR,     MEAN_LOOK, CURSE, SHADOW_BALL, CONFUSE_RAY
	db 35, KADABRA,    DISABLE, PSYBEAM, RECOVER, FUTURE_SIGHT
	db 38, CLEFABLE,   DOUBLE_EDGE, METRONOME, PSYCHIC_M, AMNESIA
	db -1 ; end
	...
	db 35, GENGAR,     MEAN_LOOK, CURSE, SHADOW_BALL, CONFUSE_RAY
	db 35, KADABRA,    DISABLE, PSYBEAM, RECOVER, FUTURE_SIGHT
	db 38, ESPEON,     GROWTH, PSYCHIC_M, BITE, SHADOW_BALL
	db -1 ; end
...
WillGroup:
	...
	db 50, XATU,       PSYCHIC_M, DRILL_PECK, HAZE, THIEF
	db 51, JYNX,       LOVELY_KISS, BLIZZARD, PSYCHIC_M, THIEF
	db 51, EXEGGUTOR,  SLEEP_POWDER, PSYCHIC_M, GIGA_DRAIN, EGG_BOMB
	db 51, SLOWBRO,    AMNESIA, PSYCHIC_M, SURF, THUNDER_WAVE
	db 52, GIRAFARIG,  AGILITY, RETURN, THUNDER, PSYCHIC_M
	db 52, ESPEON,     GROWTH, PSYCHIC_M, HIDDEN_POWER, BATON_PASS
	db -1 ; end
...
BrunoGroup:
	...
	db 52, HITMONTOP,  MIND_READER, HI_JUMP_KICK, CURSE, PURSUIT
	db 52, HITMONLEE,  MIND_READER, HI_JUMP_KICK, SHADOW_BALL, ROCK_SLIDE
	db 52, HITMONCHAN, AGILITY, MACH_PUNCH, ICE_PUNCH, SHADOW_BALL
	db 53, ONIX,       SHARPEN, ROCK_SLIDE, EARTHQUAKE, ROAR
	db 56, MACHAMP,    CURSE, CROSS_CHOP, ROCK_SLIDE, FIRE_BLAST
	db 55, HERACROSS,  CURSE, MACH_PUNCH, MEGAHORN, EARTHQUAKE
	db -1 ; end

KarenGroup:
	; KAREN (1)
	db "KAREN@", TRAINERTYPE_MOVES
	db 52, UMBREON,    GROWTH, PURSUIT, TOXIC, PSYCHIC_M
	db 52, VILEPLUME,  SLEEP_POWDER, LEECH_SEED, SLUDGE_BOMB, MOONLIGHT
	db 55, GENGAR,     HYPNOSIS, SHADOW_BALL, SLUDGE_BOMB, SUBMISSION
	db 54, MURKROW,    DRILL_PECK, FAINT_ATTACK, STEEL_WING, TOXIC
	db 57, HOUNDOOM,   SUNNY_DAY, FLAMETHROWER, CRUNCH, SOLARBEAM
	db 57, TYRANITAR,  ROCK_SLIDE, PURSUIT, FIRE_BLAST, EARTHQUAKE
	db -1 ; end

KogaGroup:
	; KOGA (1)
	db "KOGA@", TRAINERTYPE_MOVES
	db 50, ARIADOS,    AGILITY, THIEF, TWINEEDLE, SLUDGE_BOMB
	db 51, VENOMOTH,   CURSE, SLUDGE_BOMB, SLEEP_POWDER, HIDDEN_POWER
	db 53, FORRETRESS, SPIKES, RAPID_SPIN, EXPLOSION, GIGA_DRAIN
	db 52, MUK,        CURSE, SLUDGE_BOMB, FIRE_BLAST, EXPLOSION
	db 54, CROBAT,     WING_ATTACK, SLUDGE_BOMB, CONFUSE_RAY, MEAN_LOOK
	db 55, QWILFISH,   HAZE, SLUDGE_BOMB, HYDRO_PUMP, SPIKES
	db -1 ; end

ChampionGroup:
	; CHAMPION (1)
	db "LANCE@", TRAINERTYPE_MOVES
	db 54, GYARADOS,   RAIN_DANCE, WATERFALL, ROAR, EARTHQUAKE
	db 57, DRAGONITE,  THUNDER_WAVE, DRAGONBREATH, ICE_BEAM, THUNDER
	db 57, DRAGONITE,  DYNAMICPUNCH, DRAGONBREATH, BLIZZARD, DOUBLE_EDGE
	db 56, AERODACTYL, ROCK_SLIDE, DRILL_PECK, OUTRAGE, SHARPEN
	db 56, CHARIZARD,  BELLY_DRUM, FIRE_BLAST, WING_ATTACK, OUTRAGE
	db 60, DRAGONITE,  WING_ATTACK, OUTRAGE, WATERFALL, THUNDER
	db -1 ; end

BrockGroup:
	; BROCK (1)
	db "BROCK@", TRAINERTYPE_MOVES
	db 60, GOLEM,      SHARPEN, EARTHQUAKE, ROCK_SLIDE, FIRE_BLAST
	db 60, RHYDON,     EARTHQUAKE, ROCK_SLIDE, CURSE, FIRE_BLAST
	db 62, OMASTAR,    SURF, HIDDEN_POWER, ICE_BEAM, ANCIENTPOWER
	db 64, ONIX,       SHARPEN, SANDSTORM, ROCK_SLIDE, EARTHQUAKE
	db 62, KABUTOPS,   SWORDS_DANCE, ANCIENTPOWER, SUBMISSION, SURF
	db -1 ; end

MistyGroup:
	; MISTY (1)
	db "MISTY@", TRAINERTYPE_MOVES
	db 62, GOLDUCK,    HYPNOSIS, SURF, ICE_BEAM, HIDDEN_POWER
	db 62, QUAGSIRE,   AMNESIA, REST, EARTHQUAKE, SURF
	db 64, LAPRAS,     SURF, ICE_BEAM, THUNDERBOLT, SING
	db 67, STARMIE,    SURF, PSYCHIC_M, RAPID_SPIN, RECOVER
	db -1 ; end

LtSurgeGroup:
	; LT_SURGE (1)
	db "LT.SURGE@", TRAINERTYPE_MOVES
	db 64, RAICHU,     SURF, THUNDERBOLT, LOVELY_KISS, RAIN_DANCE
	db 70, ELECTRODE,  THUNDER_WAVE, THUNDERBOLT, EXPLOSION, HIDDEN_POWER
	db 70, MAGNETON,   THUNDERBOLT, THUNDER_WAVE, HIDDEN_POWER, SUBSTITUTE
	db 70, ELECTRODE,  LIGHT_SCREEN, REFLECT, THUNDERBOLT, EXPLOSION
	db 66, ELECTABUZZ, THUNDER, PSYCHIC_M, ICE_PUNCH, HIDDEN_POWER
	db -1 ; end
...
ErikaGroup:
	...
	db 72, TANGELA,    STUN_SPORE, SLEEP_POWDER, GIGA_DRAIN, REFLECT
	db 71, JUMPLUFF,   SLEEP_POWDER, GIGA_DRAIN, HIDDEN_POWER, LEECH_SEED
	db 66, VICTREEBEL, SUNNY_DAY, SWORDS_DANCE, SOLARBEAM, SLUDGE_BOMB
	db 66, BELLOSSOM,  SLEEP_POWDER, SWORDS_DANCE, GIGA_DRAIN, SLUDGE_BOMB
	db 66, MEGANIUM,  SUNNY_DAY, SOLARBEAM, ANCIENTPOWER, EARTHQUAKE
	db -1 ; end
...
SchoolboyGroup:
	...
	db 35, XATU,       FARORES_WIND, NIGHT_SHADE, SWIFT, FUTURE_SIGHT
...
LassGroup:
	...
	db 18, SNUBBULL,   SCARY_FACE, CHARM, BITE, SHADOW_FLARE
	db -1 ; end
...
JanineGroup:
	...
	db 66, CROBAT,     WING_ATTACK, HIDDEN_POWER, TOXIC, SCREECH
	db 66, WEEZING,    SLUDGE_BOMB, THUNDER, FIRE_BLAST, EXPLOSION
	db 66, WEEZING,    SLUDGE_BOMB, HIDDEN_POWER, EXPLOSION, HAZE
	db 73, ARIADOS,    SPIDER_WEB, AGILITY, THIEF, SLUDGE_BOMB
	db 69, VENOMOTH,   CURSE, SLUDGE_BOMB, SLEEP_POWDER, HIDDEN_POWER
	db -1 ; end
...
CooltrainerMGroup:
	...
	db 35, KINGLER,    NAYRUS_PSALM, STOMP, GUILLOTINE, PROTECT
	...
	db 32, KINGLER,    NAYRUS_PSALM, STOMP, GUILLOTINE, PROTECT
...
CooltrainerFGroup:
	...
	db 33, HORSEA,     SMOKESCREEN, LEER, WHIRLPOOL, ELDINS_WRATH
	db 33, HORSEA,     SMOKESCREEN, LEER, WHIRLPOOL, ELDINS_WRATH
	db 35, SEADRA,     SWIFT, LEER, WATERFALL, ELDINS_WRATH
	db -1 ; end
...
PokemaniacGroup:
	...
	db 12, LICKITUNG,  SHADOW_FLARE, SUPERSONIC, CUT, NO_MOVE
	db -1 ; end
...
SabrinaGroup:
	...
	db 68, ALAKAZAM,   PSYCHIC_M, SUBSTITUTE, FIRE_PUNCH, RECOVER
	db 68, GENGAR,     SHADOW_BALL, ICE_PUNCH, HYPNOSIS, DREAM_EATER
	db 68, ALAKAZAM,   PSYCHIC_M, SUBSTITUTE, RECOVER, DYNAMICPUNCH
	db -1 ; end
...
FisherGroup:
	...
	db 25, REMORAID,   LOCK_ON, PSYBEAM, JABUS_FROST, NAYRUS_PSALM
	db 25, REMORAID,   LOCK_ON, PSYBEAM, JABUS_FROST, NAYRUS_PSALM
	db -1 ; end
	...
	db 34, SEAKING,    SUPERSONIC, WATERFALL, FLAIL, FURY_ATTACK
	db 38, REMORAID,   PSYBEAM, JABUS_FROST, NAYRUS_PSALM, HYPER_BEAM
	db -1 ; end
	...
	db 35, QWILFISH,   TOXIC, MINIMIZE, SURF, SILVER_WIND
	...
	db 34, SEAKING,    SUPERSONIC, RAIN_DANCE, WATERFALL, FURY_ATTACK
	db 37, QWILFISH,   ROLLOUT, SURF, SILVER_WIND, TAKE_DOWN
	db -1 ; end
...
SwimmerFGroup:
	...
	db 22, GOLDEEN,    FARORES_WIND, TAIL_WHIP, SUPERSONIC, HORN_ATTACK
	db -1 ; end
...
SailorGroup:
	...
	db 20, KRABBY,     NAYRUS_PSALM, LEER, VICEGRIP, HARDEN
	db -1 ; end
...
SuperNerdGroup:
	...
	db 39, SEADRA,     SMOKESCREEN, ELDINS_WRATH, SURF, WATERFALL
	db -1 ; end
...
Rival2Group:
	...
	db 45, RAICHU,     RAIN_DANCE, THUNDER, SURF, PETAL_DANCE
	db -1 ; end
	...
	db 43, GENGAR,     MEAN_LOOK, CURSE, SHADOW_BALL, CONFUSE_RAY
	db 43, ALAKAZAM,   DISABLE, RECOVER, FUTURE_SIGHT, PSYCHIC_M
	db 45, CLEFABLE,   DOUBLE_EDGE, METRONOME, PSYCHIC_M, AMNESIA
	db -1 ; end
	...
	db 43, GENGAR,     MEAN_LOOK, CURSE, SHADOW_BALL, CONFUSE_RAY
	db 43, ALAKAZAM,   DISABLE, RECOVER, FUTURE_SIGHT, PSYCHIC_M
	db 45, ESPEON,     GROWTH, PSYCHIC_M, BITE, DOUBLE_TEAM
	db -1 ; end
	...
	db 50, RAICHU,     RAIN_DANCE, THUNDER, SURF, FLY
	db -1 ; end
	...
	db 46, GENGAR,     MEAN_LOOK, CURSE, SHADOW_BALL, CONFUSE_RAY
	db 46, ALAKAZAM,   RECOVER, FUTURE_SIGHT, PSYCHIC_M, REFLECT
	db 50, CLEFABLE,   SKULL_BASH, METRONOME, PSYCHIC_M, AMNESIA
	db -1 ; end
	...
	db 46, GENGAR,     MEAN_LOOK, CURSE, SHADOW_BALL, CONFUSE_RAY
	db 46, ALAKAZAM,   RECOVER, FUTURE_SIGHT, PSYCHIC_M, REFLECT
	db 50, ESPEON,     GROWTH, PSYCHIC_M, SHADOW_BALL, HIDDEN_POWER
	db -1 ; end
...
BlaineGroup:
	...
	db 73, MAGCARGO,   CURSE, ROCK_SLIDE, EARTHQUAKE, FIRE_BLAST
	db 73, MAGMAR,     FIRE_BLAST, THUNDERPUNCH, SUNNY_DAY, HIDDEN_POWER
	db 79, RAPIDASH,   HYPNOSIS, CURSE, FIRE_BLAST, IRON_TAIL
	db 75, ARCANINE,   SUNNY_DAY, FLAMETHROWER, BODY_SLAM, SOLARBEAM
	db 77, MOLTRES,    SUNNY_DAY, FIRE_BLAST, REST, SLEEP_TALK
	db 78, CHARIZARD,  BELLY_DRUM, EARTHQUAKE, ROCK_SLIDE, FIRE_BLAST
	db -1 ; end
...
ExecutiveMGroup:
	...
	db 35, HOUNDOOM,   SUNNY_DAY, FIRE_BLAST, PURSUIT, SOLARBEAM
	db 32, WEEZING,    SLUDGE_BOMB, THUNDER, EXPLOSION, HAZE
	db 33, RATICATE,   FRUSTRATION, SUBSTITUTE, MIMIC, BODY_SLAM
	db -1 ; end

	; EXECUTIVEM (2)
	db "EXECUTIVE@", TRAINERTYPE_MOVES
	db 32, GOLBAT,     WING_ATTACK, HIDDEN_POWER, TOXIC, RETURN
	db -1 ; end

	; EXECUTIVEM (3)
	db "EXECUTIVE@", TRAINERTYPE_MOVES
	db 34, WEEZING,    SLUDGE_BOMB, THUNDER, EXPLOSION, FIRE_BLAST
	db 32, GOLBAT,     WING_ATTACK, HIDDEN_POWER, TOXIC, SCREECH
	db 32, RATICATE,   SUPER_FANG, SUBSTITUTE, MIMIC, BODY_SLAM
	db 34, RHYDON,     EARTHQUAKE, ROCK_SLIDE, CURSE, ROAR
	db 37, NIDOKING,   EARTHQUAKE, LOVELY_KISS, ICE_BEAM, THUNDER
	db 40, KANGASKHAN, BODY_SLAM, EARTHQUAKE, ATTRACT, SUBSTITUTE
	db -1 ; end
...
ExecutiveFGroup:
	; EXECUTIVEF (1)
	db "EXECUTIVE@", TRAINERTYPE_MOVES
	db 35, ARBOK,      SLUDGE_BOMB, GLARE, EARTHQUAKE, SCREECH
	db 37, VILEPLUME,  SLEEP_POWDER, LEECH_SEED, SLUDGE_BOMB, CURSE
	db 39, MURKROW,    DRILL_PECK, PURSUIT, FAINT_ATTACK, TOXIC
	db 35, NIDOQUEEN,  EARTHQUAKE, THUNDER, ICE_BEAM, LOVELY_KISS
	db 35, RHYDON,     EARTHQUAKE, ROCK_SLIDE, CURSE, FURY_CUTTER
	db -1 ; end

	; EXECUTIVEF (2)
	db "EXECUTIVE@", TRAINERTYPE_MOVES
	db 33, ARBOK,      SLUDGE_BOMB, GLARE, EARTHQUAKE, GIGA_DRAIN
	db 34, GLOOM,      STUN_SPORE, CURSE, SLUDGE_BOMB, HIDDEN_POWER
	db 35, MURKROW,    DRILL_PECK, FAINT_ATTACK, PURSUIT, NIGHT_SHADE
	db 35, NIDOQUEEN,  EARTHQUAKE, THUNDER, FIRE_BLAST, MOONLIGHT
	db -1 ; end
...
TwinsGroup:
	...
	db 35, DRATINI,    THUNDER_WAVE, ELDINS_WRATH, FLAMETHROWER, HEADBUTT
	db 35, DRATINI,    THUNDER_WAVE, ELDINS_WRATH, ICE_BEAM, HEADBUTT
	db -1 ; end

	; TWINS (10)
	db "LEA & PIA@", TRAINERTYPE_MOVES
	db 38, DRATINI,    THUNDER_WAVE, ELDINS_WRATH, ICE_BEAM, HEADBUTT
	db 38, DRATINI,    THUNDER_WAVE, ELDINS_WRATH, FLAMETHROWER, HEADBUTT
	db -1 ; end
...
RedGroup:
	...
	db 90, PIKACHU,    THUNDERBOLT, SURF, LOVELY_KISS, HIDDEN_POWER
	db 85, ESPEON,     GROWTH, PSYCHIC_M, HIDDEN_POWER, BITE
	db 81, SNORLAX,    CURSE, DOUBLE_EDGE, REST, LOVELY_KISS
	db 87, VENUSAUR,   SWORDS_DANCE, GIGA_DRAIN, BODY_SLAM, SLEEP_POWDER
	db 87, CHARIZARD,  FLAMETHROWER, WING_ATTACK, ROCK_SLIDE, EARTHQUAKE
	db 87, BLASTOISE,  RAIN_DANCE, SURF, THUNDER, BLIZZARD
	db -1 ; end

BlueGroup:
	; BLUE (1)
	db "BLUE@", TRAINERTYPE_MOVES
	db 76, PIDGEOT,    WING_ATTACK, STEEL_WING, RETURN, MIRROR_MOVE
	db 78, ALAKAZAM,   PSYCHIC_M, DYNAMICPUNCH, RECOVER, FIRE_PUNCH
	db 80, RHYDON,     EARTHQUAKE, ROCK_SLIDE, CURSE, ROAR
	db 78, GYARADOS,   RAIN_DANCE, HYDRO_PUMP, THUNDER, ROAR
	db 79, EXEGGUTOR,  SLEEP_POWDER, PSYCHIC_M, GIGA_DRAIN, HIDDEN_POWER
	db 80, ARCANINE,   SUNNY_DAY, FLAMETHROWER, SOLARBEAM, EXTREMESPEED
	db -1 ; end
...
MysticalmanGroup:
	...
	db 23, HAUNTER,    SHADOW_FLARE, HYPNOSIS, MEAN_LOOK, CURSE
